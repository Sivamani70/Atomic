...
- [Email to Word Document Parser (eml_2_docx)](#email-to-word-document-parser-eml_2_docx)
  ...
  - [Examples](#examples)
    - [Example 1: Basic Email Analysis](#example-1-basic-email-analysis)
    - [Example 2: Batch Processing Multiple Emails](#example-2-batch-processing-multiple-emails)
    - [Example 3: Using Current Directory for Output](#example-3-using-current-directory-for-output)
    - [Example 4: Empty Incident Number (Not Recommended)](#example-4-empty-incident-number-not-recommended)
  - [Report Elements](#report-elements-1)
    - [Email Metadata Extraction](#email-metadata-extraction)
    - [Domain Analysis Data](#domain-analysis-data)
    - [Threat Intelligence References](#threat-intelligence-references)
  - [Customization](#customization)
    - [Changing Document Formatting](#changing-document-formatting)
    - [Common Color Codes](#common-color-codes)
    - [Modifying Report Sections](#modifying-report-sections)
  - [Troubleshooting](#troubleshooting)
    - [Issue: "Cannot find Word application"](#issue-cannot-find-word-application)
    - [Issue: "API Key Error" or HTTP 401](#issue-api-key-error-or-http-401)
    - [Issue: "Domain not found in VirusTotal"](#issue-domain-not-found-in-virustotal)
    - [Issue: Output file not created in expected location](#issue-output-file-not-created-in-expected-location)
    - [Issue: "Zombie" Word processes remain after completion](#issue-zombie-word-processes-remain-after-completion)
