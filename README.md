...
- [Usage](#-usage)
  - [Option 1: SOLO](#option-1-solo-separate-output-logging-orchestrator)
  - [Option 2: MIXR](#option-2-mixr-malware-investigation-and-excel-report)
  - [Option 3: AbuseIPDB](#option-3-abuseipdb-dedicated-ip-reputation-analysis)
- [Supported File Formats](#-supported-file-formats-for-iocs)
